...
function cargarRutaMenu(ruta, idContenedor,idLabel) {
    var contenedor = '#' + idContenedor;
    var label = '#' + idLabel;
...
function mostrarMensaje (mensaje, tipo) {
	...
	if (tipo === 'ERROR') {
		$.Notification.autoHideNotify('error', 'top right', mensaje,'La accion presento error interno');
	} else if(tipo === 'OK'){
		$.Notification.autoHideNotify('success', 'top right', mensaje,'La accion se ejecutó sin errores');
	}
